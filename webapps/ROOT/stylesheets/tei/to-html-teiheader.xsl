...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0"
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse-encodingDesc">Encoding description</a>
        </h4>
      </div>
      <div id="collapse-encodingDesc" class="panel-collapse collapse in">
        <div class="panel-body"><xsl:apply-templates /></div>
      </div>
    </div>
  </xsl:template>
  ...
  <xsl:template match="tei:fileDesc">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse-fileDesc">Digital document details</a>
        </h4>
      </div>
      <div id="collapse-fileDesc" class="panel-collapse collapse in">
        <div class="panel-body"><xsl:apply-templates select="tei:*[not(local-name()='sourceDesc')]" /></div>
      </div>
    </div>
  ...
  <xsl:template match="tei:sourceDesc">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse-sourceDocumentDetails">Source document details</a>
        </h4>
      </div>
      <div id="collapse-sourceDocumentDetails" class="panel-collapse collapse in">
        <div class="panel-body"><xsl:apply-templates /></div>
      </div>
    </div>
  </xsl:template>
  ...
  <xsl:template match="tei:teiHeader">
    ...
    <div class="panel-group" id="accordion">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapse-otherFormats">Other Formats</a>
          </h4>
        </div>
        <div id="collapse-otherFormats" class="panel-collapse collapse in">
